        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Your one-stop destination for trendy and affordable clothing for the whole family.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/products?category=men" className="text-gray-300 hover:text-white">Men's Clothing</Link>
              </li>
              <li>
                <Link to="/products?category=women" className="text-gray-300 hover:text-white">Women's Clothing</Link>
              </li>
              <li>
                <Link to="/products?category=kids" className="text-gray-300 hover:text-white">Kids' Clothing</Link>
              </li>
              <li>
                <Link to="/products?category=accessories" className="text-gray-300 hover:text-white">Accessories</Link>
              </li>
              <li>
                <Link to="/products?category=sale" className="text-gray-300 hover:text-white">Sale Items</Link>
              </li>
            </ul>
          </div>
