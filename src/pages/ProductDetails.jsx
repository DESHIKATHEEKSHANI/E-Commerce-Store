  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        const relatedRes = await axios.get(`/api/products?category=${res.data.category}&limit=4`);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="border-t pt-6">
            ...
            <div>
              <span className="font-semibold">SKU:</span> {product._id.substring(0, 8).toUpperCase()}
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {relatedProducts.map(relProduct => (
              <div key={relProduct._id} className="border rounded-lg overflow-hidden">
                <Link to={`/product/${relProduct._id}`}>
                  ...
                  <div className="p-4">
                    ...
                    <div className="text-gray-800">${relProduct.price.toFixed(2)}</div>
                  </div>
                </Link>
              </div>
            ))}
